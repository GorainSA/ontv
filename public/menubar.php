        ...
        <nav class="cyan">
            <div class="nav-wrapper">
                <h1 class="logo-wrapper"><a href="dashboard.php" class="brand-logo darken-1"><img
                        src="assets/images/logo-black.png" alt="materialize logo"></a><span
                        class="logo-text">On TV Media</span></h1>
            ...
            <ul id="slide-out" class="side-nav fixed leftside-navigation">
                ...
                <li class="bold">
                    <a href="" class="waves-effect waves-cyan">
                        <i class="mdi-av-radio"></i>Estates
                    </a>
                </li>
                <li class="bold">
                    <a href="" class="waves-effect waves-cyan">
                        <i class="mdi-av-radio"></i>Users
                    </a>
                </li>
